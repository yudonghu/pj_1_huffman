...
public class huffman_compress_with_single_thread implements Callable {
...
//            System.out.println("Total time used(in milli-sec):"+(writingResult.endTime-bytesStringResult.startingTime )/1_000_000);
    ...
    public static void main(String []args) throws ExecutionException, InterruptedException {
        huffman_compress_with_single_thread mainThread = new huffman_compress_with_single_thread();
